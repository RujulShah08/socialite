...
function Sidebar() {
    ...
    let currentPathname = location.pathname.split('/').splice(-2)[0]
    if (currentPathname != undefined && currentPathname == "") {
        currentPathname = location.pathname.split('/').splice(-2)[1]
    } else {
        currentPathname = location.pathname.split('/').splice(-2)[0]
    }
    return (
        <div
            id="site__sidebar"
                                ...
                                >
                                    <nav id="side">
                                        <ul>
                                            ...
                                            <li className={`${currentPathname == 'messages' && 'active'}`}>
                                                <NavLink to="/messages">
                                                    <img
